...
- Em contraste com essa decisão, fizemos um menu dropdown com uma essência parecida, para dar acesso aos destinos.
- Importante mencionar que nos sketches tavamos com planos de manter o header e o footer flutuantes, ou seja o scroll só iria alterar o conteúdo do **main**. Ideia que muito rapidamente deixamos para trás, por motivos visuais.
