...
O Netlify inicialmente não dava deploy a qualquer ficheiro que estivesse numa sub-folder, então nós, querendo evitar que o repositório ficasse desorganizado conseguimos mudar nas definições de deploy para que a plataforma apenas fosse ler o código da sub-folder.
