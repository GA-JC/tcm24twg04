...
| Seletores Simples | <img src="docs-img/ex.seletoressimples.png" alt="ex.seletoressimples" width="400" /> |
| Seletor de Pseudo-elementos e Seletor Combinador | <img src="docs-img/ex.pseudoecombinador.png" alt="ex.pseudoecombinador" width="400" /> |
| Propriedades do Texto e da Fonte | <img src="docs-img/ex.textoefonte.png" alt="ex.textoefonte" width="400" /> |
| Formatação do Fundo de Página | <img src="docs-img/ex.formatopg.png" alt="ex.formatopg" width="400" /> |
| Formatação de Estilo para uma Lista | <img src="docs-img/ex.formatolista.png" alt="ex.formatolista" width="400" /> |
| Manipulação dos 4 Elementos de Formatação da Caixa de Elementos HTML | <img src="docs-img/ex.4elcaixa.png" alt="ex.4elcaixa" width="400" /> |
...
| Esconder um Elemento | <img src="docs-img/ex.esconderele.png" alt="ex.esconderele" width="400" /> |
| Formatação de uma Tabela | <img src="docs-img/ex.formattabela.png" alt="ex.formattabela" width="400" /> |
| Substituição de um Elemento por uma Imagem | <img src="docs-img/ex.eleporimg.png" alt="ex.eleporimg" width="400" /> |
| Responsividade para Duas Dimensões de Ecrã (Media Queries) | <img src="docs-img/ex.media.png" alt="ex.media" width="400" /> |
